            ...
            foreach ($users as $user) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-md 4">
                                <a class="btn btn-success" href="<?= $updateUrl ?>?<?= $navOrderByQueryString ?>&page=<?= $page ?>&action=update&id=<?= $user['id'] ?>">
                                    <i class="fa fa-pen"></i>
                                    UPDATE
                                </a>
                            ...
                            <div class="col-md 4">
                                <a onclick="return confirm('DELETE USER?')" class="btn btn-danger" href="<?= $deleteUrl ?>?<?= $navOrderByQueryString ?>&page=<?= $page ?>&id=<?= $user['id'] ?>&action=delete">
